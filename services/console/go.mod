module github.com/ScientificInternet/Google-Monetize/services/console
...
require (
	...
	github.com/ScientificInternet/Google-Monetize/pkg/pagination v0.0.0-00010101000000-000000000000
