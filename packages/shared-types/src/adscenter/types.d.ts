...
export interface paths {
    ...
    "/api/v1/adscenter/accounts/stream": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/adscenter/accounts/sync-all": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["syncAllAccounts"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/adscenter/execution-report": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/adscenter/budget/transfer": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["transferBudget"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/adscenter/configurations/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        AdjustCpcParams: {
            ...
            keyword?: string;
            /** @description Increase/decrease percent (e.g., 10 for +10%) */
            percent?: number;
        ...
        /** @description Parameters for pausing/enabling keyword criteria */
        KeywordStatusParams: {
            criterionResourceNames: string[];
        };
        /** @description Replace campaign ad schedules with provided list */
        AdSchedulesParams: {
        ...
        /** @description Set bidding targets for campaigns (tCPA/tROAS) */
        BiddingParams: {
            campaignResourceNames: string[];
            /** @description Absolute target CPA in micros */
            targetCpaMicros?: number;
            /** @description Absolute target ROAS value */
            targetRoas?: number;
            /** @description Relative adjustment percent */
            percent?: number;
        };
